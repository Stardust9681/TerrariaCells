...
{
    public class DungeonPylon : CustomPylon
    {
        public const int CrystalVerticalFrameCount = 8;
        public override string CrystalTexture => $"{Texture}_Crystal";
        public override string OutlineTexture => Texture.Replace("DungeonPylon", "PylonHighlight");
        public override string MapIconTexture => $"{Texture}_MapIcon";
        public override void SafeSetStaticDefaults()
        {
            AddMapEntry(Color.LightSteelBlue, CreateMapEntryName());
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            DrawCrystal(i, j, spriteBatch, CrystalVerticalFrameCount, Color.LightSteelBlue);
        }
        ...
        {
            Vector3 lightColour = Color.LightSteelBlue.ToVector3() * 0.8f;
            r = lightColour.X;
            g = lightColour.Y;
            b = lightColour.Z;
        }
